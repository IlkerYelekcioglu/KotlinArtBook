package com.yelek.artbookkotlin
...
import com.yelek.artbookkotlin.databinding.ActivityArtBinding
...
class ArtActivity : AppCompatActivity() {
    ...
    fun saveButtonClicked(view:View){
        ...
        if(selectedBitmap != null){
            ...
            //FLAG_ACTIVITY_CLEAR_TOP bu şu demektir.Bundan önce açık olan ne kadar aktivite varsa  onu kapatıyorsun demektir.
